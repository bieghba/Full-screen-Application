		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#studentcomsaptrainingux402fullscreenux402fullscreen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"studentcomsaptrainingux402fullscreenux402fullscreen-display": {
								"semanticObject": "studentcomsaptrainingux402fullscreenux402fullscreen",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student.com.sap.training.ux402.fullscreen.ux402fullscreen",
									"url": sap.ui.require.toUrl("student/com/sap/training/ux402/fullscreen/ux402fullscreen")
								}
							}
						}
					}
